        ...
        <section className={styles.sectionAbout}>
         <div className={styles.divImage}>
          ...
          <div className={styles.aboutMe}>
                ...
                <h3></h3>
                <p>Como um desenvolvedor full stack junior, dedico-me a transformar ideias em aplicações web inovadoras, buscando sempre as melhores ferramentas e métricas de desenvolvimento. Explore meu portifólio, monstrando minha experiência em desenvolvimento web.</p>
              </div>
